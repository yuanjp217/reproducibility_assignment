...
sum(pre$acc_location_report==1) / length(pre$id)
...
#location task
sum(ctrl$acc_location_report == 1) / 20
```
...
ctrl2 = acc_d %>%
  filter(trial == 158)
#color task
sum(ctrl2$acc_color_report == 1) / 20

#identity task
sum(ctrl2$acc_identity_report == 1) / 20

#location task
sum(ctrl2$acc_location_report == 1) / 20
```
...
ctrl3 = acc_d %>%
  filter(trial == 159)
#color task
sum(ctrl3$acc_color_report == 1) / 20

#identity task
sum(ctrl3$acc_identity_report == 1) / 20

#location task
sum(ctrl3$acc_location_report == 1) / 20
```
```{r 4th control}
ctrl4 = acc_d %>%
  filter(trial == 160)
