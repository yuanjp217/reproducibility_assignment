...
colnames(d)= c("id", "block", "trial", "color_target", "identity_target", "location_target", "color_response", "identity_response", "acc_color_report", "acc_identity_report", "acc_location_report")
head(d)
```
