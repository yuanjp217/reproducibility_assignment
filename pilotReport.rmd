...
reportObject <- reproCheck(reportedValue = '0.8', obtainedValue = ctrl4_color, valueType = 'other', round = TRUE)
#identity task
ctrl4_identity <- sum(ctrl4$acc_identity_report == 1) / 20
reportObject <- reproCheck(reportedValue = '0.75', obtainedValue = ctrl4_identity, valueType = 'other', round = TRUE)
#location task
ctrl4_location <- sum(ctrl4$acc_location_report == 1) / 20
reportObject <- reproCheck(reportedValue = '0.7', obtainedValue = ctrl4_location, valueType = 'other', round = TRUE)
```
...
reportObject <- reproCheck(reportedValue = '0.011', obtainedValue = b_value, valueType = 'p', round = TRUE)
...
reportObject <- reproCheck(reportedValue = '<0.005', obtainedValue = c_value, valueType = 'p', eyeballCheck = TRUE, round = TRUE)
```
